...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_1/h_residualWidthX1");
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_2/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_3/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_4/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_5/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_6/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_7/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_8/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_9/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_10/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_11/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_12/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_13/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_14/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_15/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_16/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_17/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_18/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_19/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_20/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_21/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_22/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_23/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_24/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_25/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_26/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_27/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);
...
// 1D-Histo (comparison)
  ...
  TString histName("Sector_28/h_residualWidthX1");
    file1->GetObject(histName + ";1", hist1);
    file2->GetObject(histName + ";1", hist2);

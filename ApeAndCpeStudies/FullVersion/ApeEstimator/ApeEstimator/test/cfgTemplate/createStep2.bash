...
summaryTemplateFile="${CMSSW_BASE}/src/ApeEstimator/ApeEstimator/test/cfgTemplate/summaryTemplate.bash"

summaryFile="${CMSSW_BASE}/src/ApeEstimator/ApeEstimator/test/batch/workingArea/summary.bash"
...
ROOTFILEBASE="$CMSSW_BASE/src/ApeEstimator/ApeEstimator/hists"

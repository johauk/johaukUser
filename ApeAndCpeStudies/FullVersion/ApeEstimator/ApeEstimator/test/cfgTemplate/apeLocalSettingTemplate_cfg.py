...
process.AlignmentProducer.algoConfig.apeASCIIReadFile = 'ApeEstimator/ApeEstimator/hists/workingArea/iter_THE_ITERATION_/allData_apeOutput.txt'
...
process.PoolDBOutputService = cms.Service(
    ...
    connect = cms.string('sqlite_file:/afs/cern.ch/user/h/hauk/scratch0/apeStudies/apeObjects/apeIter_THE_ITERATION_.db'),
    toPut = cms.VPSet(
        cms.PSet(

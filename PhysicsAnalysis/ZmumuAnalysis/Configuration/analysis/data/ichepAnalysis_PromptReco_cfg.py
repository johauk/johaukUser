...
## sources
#process.load("ZmumuAnalysis.Configuration.samples.data.Collisions10.IchepAnalysis_PromptReco_cff")
process.load("ZmumuAnalysis.Configuration.samples.data.Certification.IchepAnalysis_PromptReco_cff")
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string(os.environ['CMSSW_BASE'] + '/src/ZmumuAnalysis/Configuration/hists/data/ichep_PromptReco.root'),

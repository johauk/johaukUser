#include "signalAndSidebandCombined.h"
...
TH1* Tools::signalAndSidebandCombined(TFile* file, const TString& pluginSuffix, const TString& pluginBase, const TString& subFolder, const TString& histName){

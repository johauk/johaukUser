...
TFile* file1 = TFile::Open("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/analysis/data/False_HeM__True_default/mc/zmumuB.root");
TFile* file2 = TFile::Open("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/analysis/data/False_HeM__True_default/mc/zmumuC.root");
TFile* file3 = TFile::Open("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/analysis/data/False_HeM__True_default/mc/zmumuUds.root");
TFile* file4 = TFile::Open("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/analysis/data/False_HeM__True_default/mc/ttbar.root");

TH1 *hist1, *hist2, *hist3, *hist4;

TLegend* legend1;

TString legendEntry1 = "bZ", legendEntry2 = "cZ", legendEntry3 = "lZ", legendEntry4 = "ttbar";
Double_t yMax1, yMax2, yMax3, yMax4;
Double_t yMin1, yMin2, yMin3, yMin4;
TString outputDirectory = "$CMSSW_BASE/src/ZmumuAnalysis/Configuration/macros/plots/reco_zVsTop_";
...
// 1D-Histo (comparison)
  ...
  TString histName("MuonAnalyzerStep2/MuonProperties/h_pt");
  ...
  TString plotName(outputDirectory + "mu_pt");

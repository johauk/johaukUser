...
const TString* outpath = new TString("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/macros/plots/Met_");
...
void MetPlots(TString pluginSuffix = ""){
  ...
  pluginName = new TString("MetAnalyzer");
  ...
  histName1 = new TString("MetProperties/h_missingEt");
  // Give base name of output plot
  plotName1 = new TString("missingEt");

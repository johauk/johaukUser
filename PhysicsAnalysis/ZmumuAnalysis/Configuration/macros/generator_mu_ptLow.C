...
// 1D-Histo (comparison)
  ...
  line1 = new TLine(20., yMin,20., yMax);line1->SetLineStyle(2);line1->SetLineWidth(2);
  //line2 = new TLine(76., yMin,76., yMax);line2->SetLineStyle(2);line2->SetLineWidth(2);
  //line3 = new TLine(106.,yMin,106.,yMax);line3->SetLineStyle(2);line3->SetLineWidth(2);
  //line4 = new TLine(120.,yMin,120.,yMax);line4->SetLineStyle(3);line4->SetLineWidth(2);

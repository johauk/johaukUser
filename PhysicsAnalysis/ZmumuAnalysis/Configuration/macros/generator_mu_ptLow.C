...
// 1D-Histo (comparison)
  ...
  TString histName("GeneratorZmumuAnalyzerVisible3/SingleMu/h_muPtLow");
  ...
  line1 = new TLine(20., yMinHist,20., yMaxHist);line1->SetLineStyle(2);line1->SetLineWidth(2);
  //line2 = new TLine(76., yMinHist,76., yMaxHist);line2->SetLineStyle(2);line2->SetLineWidth(2);
  //line3 = new TLine(106.,yMinHist,106.,yMaxHist);line3->SetLineStyle(2);line3->SetLineWidth(2);
  //line4 = new TLine(120.,yMinHist,120.,yMaxHist);line4->SetLineStyle(3);line4->SetLineWidth(2);
  ...
  TString plotName(outputDirectory + "mu_ptLow");

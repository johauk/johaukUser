// root -l
// .L MuonPlots.C++
// MuonPlots()        // empty to define pluginName and plotName completely by hand
// MuonPlots("bla")   // name to define pluginName and plotName via an appended suffix "bla"
...
const TString* outpath = new TString("$CMSSW_BASE/src/ZmumuAnalysis/Configuration/macros/plots/Muon_");
